  ...
  return (
    <>
      ...
      <div className="mySec">
        ...
        <div className="right">
          <img
            src="https://p26-flow-product-sign.byteimg.com/tos-cn-i-13w3uml6bg/f851fca5a973417883e2ea7a894f9f57~tplv-13w3uml6bg-crop-center-v1:960:540.image?rk3s=2e2596fd&x-expires=1735369193&x-signature=YJfChsNxSRtS8TLXiMpfalyZu8E%3D"
            alt="app"
          />
        </div>
      </div>
          ...
          return (
            <Card
              ...
              cover={
                <img
                  alt="example"
                  src="https://p3-flow-product-sign.byteimg.com/tos-cn-i-13w3uml6bg/449e70bf477b4dfcaedfc2914b4653ee~tplv-13w3uml6bg-resize:128:128.image?rk3s=2e2596fd&x-expires=1735369192&x-signature=dK5Emi4atuCup%2FDzB%2FigKw2qeOw%3D"
                />
              }
            >
              ...
              <Meta
                title="合成新元素"
                description="通过对话的方式玩一个类似「涂鸦上帝」的元素合成游戏。初始元素是 💧 水、🔥 火、🌬️ 风、🌍 土，你可以通你可以通过不断的自由组合，来随机生成新的物质。试试看谁能把「🥽 Vision Pro」生成出来？"
              />
              <div className="foot">
                <div
                  className="footleft"
