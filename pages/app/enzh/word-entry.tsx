...
const itemBox = [
    {
      ...
      total: "965",
      title: "关卡1",
      content: "开启你的英语词汇之旅！每一个单词都是通向世界的钥匙，让我们一起打开知识的大门。循序渐进，从基础单词开始，构建你的英语词汇基石。",
    },
    {
      id: 2,
      img: "/assets/img/1.png",
      ...
      total: "965",
      title: "关卡2",
      content: "词汇量决定思维的深度！在这里，你将掌握更多日常交际必备单词，让英语表达更加自然流畅。坚持就是胜利，让我们继续前进！",
    },
    {
      id: 3,
      ...
      total: 1100,
      title: "关卡3",
      content: "知识之树正在生长！每掌握一个单词，就是给知识之树浇灌一次。让我们一起见证词汇量的指数级提升，打造属于你的英语知识森林。",
    },
    {
      id: 4,
      img: "/assets/img/1.png",
      ...
      total: "965",
      title: "关卡4",
      content: "挑战更高层次的词汇！这里有商务、科技、文学等领域的专业词汇，让你的英语表达更加精准专业。记住，每天进步一点点，终会与世界对话！",
    },
    {
      id: 5,
      img: "/assets/img/1.png",
      ...
      total: "965",
      title: "关卡5",
      content: "词根词缀大揭秘！通过词根词缀的学习，一个单词可以延伸出多个相关词汇。掌握这个技巧，让你的词汇量事半功倍！",
    },
    {
      id: 6,
      img: "/assets/img/1.png",
      ...
      total: "965",
      title: "关卡6",
      content: "同义词和反义词的世界！探索词汇的多样性，让你的英语表达更加丰富多彩。记住，优秀的人不会满足于简单的词汇重复！",
    },
    {
      id: 7,
      img: "/assets/img/1.png",
      ...
      total: "965",
      title: "关卡7",
      content: "情境化学习新境界！在真实场景中学习和运用单词，让记忆更加深刻。相信自己，你离掌握地道英语表达又近了一步！",
    },
    {
      id: 8,
      img: "/assets/img/1.png",
      ...
      total: "965",
      title: "关卡8",
      content: "词汇进阶挑战赛！这里收录了高频考试词汇，助你备战各类英语考试。坚持就是胜利，让我们一起突破词汇关卡！",
    },
    {
      id: 9,
      img: "/assets/img/1.png",
      ...
      total: "965",
      title: "关卡9",
      content: "词汇大师的终极挑战！掌握这些高级词汇，让你的英语水平更上一层楼。记住，在词汇学习的道路上，你永远不是一个人在战斗！",
    },
  ];
  const GotoNav = useCallback(
    (item) => {
      if (item === 2) {
        router.push("/app/enzh/word-Spell");
      } else if (item === 3) {
        router.push("/app/enzh/word-Spell");
      }
    },
